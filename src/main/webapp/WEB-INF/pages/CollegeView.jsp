...
<c:when test="${form.id==0}">          
                           <h3 class="text-center default-text py-3"><s:message code="label.addcollege" /></h3>
           </c:when>
<c:otherwise>              <h3 class="text-center default-text py-3"><s:message code="label.updatecollege" /></h3>
...
<sf:input path="name" class="form-control"
    ...
    <h6 style="color: #20B2AA"><s:message code="label.address" /><font color="red">*</font></h6>
...
<sf:textarea path="address" class="form-control"
    ...
    <font color="red" class="ml-5"><sf:errors path="address" /></font>
</div>     <!-- form-group// -->


 <h6 style="color: #20B2AA"><s:message code="label.city" /><font color="red">*</font></h6>
...
<sf:input path="city" class="form-control"
    ...
    <font color="red" class="ml-5"><sf:errors path="city" /></font>
</div>     <!-- form-group// -->

<h6 style="color: #20B2AA"><s:message code="label.state" /><font color="red">*</font></h6>
...
<sf:input path="state" class="form-control"
    ...
    <font color="red" class="ml-5"><sf:errors path="state" /></font>
</div>     <!-- form-group// -->
    
    <h6 style="color: #20B2AA"><s:message code="label.phoneNo" /><font color="red">*</font></h6>
...
<sf:input path="phoneNo" class="form-control"
    ...
    </div><font color="red" class="ml-5"><sf:errors path="phoneNo" /></font> 
    </div>
    <!-- form-group// -->
