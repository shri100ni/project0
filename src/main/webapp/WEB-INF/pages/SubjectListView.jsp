...
<c:if test="${empty list}">
	    ...
	    <h3 class="text-center default-text text-dark py-3"><s:message code="label.subjectlist" /></h3>
	 ...
	 <br>
	  ...
	  <div class="col-sm-2"><sf:select path="courseId" class="form-control">
...
<c:forEach items="${list}" var="subject" varStatus="ct">
					<td class="text-center"><input type="checkbox" class="checkbox" name="ids" value="${subject.id}"></td>
...
<td>
										<c:url var="editUrl" value="/ctl/Subject/AddSubject?id=" />
              							<a class="btn btn-outline-success btn-block btn-round w-50" style="border-color: #8A2BE2; color: #8A2BE2;" href="${editUrl}${subject.id}"><i class="fa fa-edit" aria-hidden="true"></i><s:message code="label.edit"/></a>
									</td>				
									</tr>
				</c:forEach>
				</tbody>
