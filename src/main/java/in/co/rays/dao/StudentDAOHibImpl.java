...
public class StudentDAOHibImpl implements StudentDAOInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#add(in.co.rays.dto.StudentDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#update(in.co.rays.dto.StudentDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#findByEmail(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#search(in.co.rays.dto.StudentDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.StudentDAOInt#search(in.co.rays.dto.StudentDTO)
	 */
