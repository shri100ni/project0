...
public class FacultyDAOHibImpl implements FacultyDAOInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#add(in.co.rays.dto.FacultyDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#update(in.co.rays.dto.FacultyDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#findByEmail(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#search(in.co.rays.dto.FacultyDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.FacultyDAOInt#search(in.co.rays.dto.FacultyDTO)
	 */
