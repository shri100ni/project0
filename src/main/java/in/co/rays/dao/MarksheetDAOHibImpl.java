...
public class MarksheetDAOHibImpl implements MarksheetDAOInt{
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#add(in.co.rays.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#update(in.co.rays.dto.MarksheetDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#findByRollNumber(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#search(in.co.rays.dto.MarksheetDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.MarksheetDAOInt#search(in.co.rays.dto.MarksheetDTO)
	 */
