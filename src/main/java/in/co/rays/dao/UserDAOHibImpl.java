...
public class UserDAOHibImpl implements UserDAOInt{
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#add(in.co.rays.dto.UserDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#update(in.co.rays.dto.UserDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#findByLogin(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#search(in.co.rays.dto.UserDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.UserDAOInt#search(in.co.rays.dto.UserDTO)
	 */
