...
import in.co.rays.dao.SubjectDAOInt;
...
public class SubjectServiceSpringImpl implements SubjectServiceInt {
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#add(in.co.rays.dto.SubjectDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#update(in.co.rays.dto.SubjectDTO)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#delete(long)
     */
    @Transactional(propagation = Propagation.REQUIRED, readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#findByName(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#findById(long)
     */
    @Transactional( readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#search(in.co.rays.dto.SubjectDTO, int, int)
     */
    @Transactional( readOnly = false)
    ...
    /* (non-Javadoc)
     * @see in.co.rays.service.SubjectServiceInt#search(in.co.rays.dto.SubjectDTO)
     */
    @Transactional( readOnly = false)
