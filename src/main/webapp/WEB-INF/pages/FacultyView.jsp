...
<c:when test="${form.id==0}">          
                           <h3 class="text-center default-text py-3"><s:message code="label.addfaculty" /></h3>
           </c:when>
<c:otherwise>              <h3 class="text-center default-text py-3"><s:message code="label.updatefaculty" /></h3>
...
<sf:input path="mobileNo" class="form-control"
    ...
    <!-- form-group// -->
     ...
     <h6 style="color: #20B2AA"><s:message code="label.emailId" /><font color="red">*</font></h6>
...
<sf:input path="emailId" class="form-control"
    ...
    </div> <font color="red" class="ml-5"><sf:errors path="emailId"/></font>
    </div>
    <!-- form-group// -->
...
<sf:select path="collegeId" class="form-control">
    ...
    <font color="red" class="ml-5"><sf:errors path="collegeId"/></font>
    </div>
    <!-- form-group// -->
