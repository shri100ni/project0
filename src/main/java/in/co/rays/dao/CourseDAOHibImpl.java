...
public class CourseDAOHibImpl implements CourseDAOInt {
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#add(in.co.rays.dto.CourseDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#update(in.co.rays.dto.CourseDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#findByName(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#search(in.co.rays.dto.CourseDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.CourseDAOInt#search(in.co.rays.dto.CourseDTO)
	 */
