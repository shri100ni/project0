...
<c:when test="${form.id==0}">          
                           <h3 class="text-center default-text py-3"><s:message code="label.addcourse" /></h3>
           </c:when>
<c:otherwise>              <h3 class="text-center default-text py-3"><s:message code="label.updatecourse" /></h3>
...
<sf:input path="name" class="form-control"
    ...
    <font color="red" class="ml-5"><sf:errors path="name" /> </font>
     ...
     <!-- form-group// -->
       ...
       <h6 style="color: #20B2AA"><s:message code="label.duration"/><font color="red">*</font></h6>
...
<sf:select path="duration" class="form-control">
    ...
    <font color="red" class="ml-5"><sf:errors path="duration"/></font>
    </div>
     <!-- form-group// -->
