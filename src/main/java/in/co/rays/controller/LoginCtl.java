...
import in.co.rays.form.ForgetPasswordForm;
...
public class LoginCtl extends BaseCtl
{
    		...
    		if(dto!=null)
    		{
              ...
              if(form.getUri()==null || form.getUri().toString().trim()=="") {
					  return "Welcome"; 
						...
						return "redirect:"+form.getUri().replace("/Project_0", "".toString().trim()); }
    ...
    public String submit(@ModelAttribute("form") @Valid ForgetPasswordForm form ,BindingResult result,Model model, Locale locale)
    {
    	...
    	System.out.println("dopost forget "+form.getOperation());
    	...
    	{	
    		...
    		try 
    		{
				...
				{
					String msg=messageSource.getMessage("forgetpass.success",null, locale);
					model.addAttribute("success",msg);
				}else
				{
