...
public class TimeTableDAOHibImpl implements TimeTableDAOInt{
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#add(in.co.rays.dto.TimeTableDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#update(in.co.rays.dto.TimeTableDTO)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#delete(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#findTimeTableDuplicacy(java.lang.Long, java.lang.String, java.util.Date)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#findTimeTableDuplicacy(java.lang.Long, java.lang.Long, java.util.Date)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#findTimeTableDuplicacy(java.lang.Long, java.lang.String, java.lang.Long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#findByPK(long)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#search(in.co.rays.dto.TimeTableDTO, int, int)
	 */
	...
	/* (non-Javadoc)
	 * @see in.co.rays.dao.TimeTableDAOInt#search(in.co.rays.dto.TimeTableDTO)
	 */
